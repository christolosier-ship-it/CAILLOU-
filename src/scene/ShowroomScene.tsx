      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          >
            ...
            <group ref={setVisualGroup} position={sessionRockTransform.position} quaternion={sessionRockTransform.rotation}>
              <RockModel
